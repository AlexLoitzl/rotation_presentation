\begin{tikzpicture}
  ...
  \node<1>[] (l) {\Large$\llbracket \text{echo}_{\text{rec}}$};
  ...
  \node<11>[single arrow, draw=black, very thick, fill=yellow, rotate=90, opacity=1,
      minimum width = 5pt, single arrow head extend=2pt,
      minimum height=7.5mm, label={[opacity=1, above=.3cm]\texttt{(Call "getc" [] h)}}] at (0.3, 2.5){}; % length of arrow
  ...
  \node<23>[single arrow, draw=black, very thick, fill=yellow, rotate=90, opacity=1,
      minimum width = 5pt, single arrow head extend=2pt,
      minimum height=7.5mm, label={[opacity=1, above=.3cm]\texttt{(Call "putc" 0 h)}}] at (0.3, 2.5){}; % length of arrow
